...
const messagesData = [
    ...
    },
    {
        ...
        text: "TikTok Support: Hi, we detected unusual activity on your account. Verify your profile now to avoid suspension in 10 minutes https://example.com/tiktok-verify-demo Tap the link to confirm your info immediately.",
        phishing: true,
        videoId: "at-hPctMC1U",
    },
    {
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen">
            ...
            <div className="md:w-1/4 w-full p-8 bg-red-100">
                ...
                <p className="mb-4">Your job is to read your messages, clear your inbox,and respond while avoiding phishing attacks.</p>
